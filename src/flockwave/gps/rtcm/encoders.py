...
class RTCMV2Encoder:
    ...
    PREAMBLE = 0x66
    _PARITY_FORMULA = [
        (0, 0xEC7CD2),  # bits 0, 1, 2, 4, 5, 9, 10, 11, 12, 13, 16, 17, 19, 22
        (1, 0x763E69),  # bits 1, 2, 3, 5, 6, 10, 11, 12, 13, 14, 17, 18, 20, 23
        (0, 0xBB1F34),  # bits 0, 2, 3, 4, 6, 7, 11, 12, 13, 14, 15, 18, 19, 21
        (1, 0x5D8F9A),  # bits 1, 3, 4, 5, 7, 8, 12, 13, 14, 15, 16, 19, 20, 22
        (1, 0xAEC7CD),  # bits 0, 2, 4, 5, 6, 8, 9, 13, 14, 15, 16, 17, 20, 21, 23
        (0, 0x2DEA27),  # bits 2, 4, 5, 7, 8, 9, 10, 12, 14, 18, 21, 22, 23
    ]
